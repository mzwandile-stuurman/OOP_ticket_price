...
class TicketSales:
    ...
    def __init__(self,master):
        ...
        self.category_menu.place(x=170,y=100)
        ...
        self.price_menu.place(x=190,y=150)
        ...
        self.category_entry.place(x=130,y=300)

        self.for_label = Label(master, text="for")
        self.for_label.place(x=310, y=300)

        self.number_entry = Entry(master, width=8)
        self.number_entry.place(x=350, y=300)
        ...
        self.number_display_entry.place(x=120,y=350)
    ...
    def CalcPrice(self):
        try:
            ...
            if category =="" or self.price_menu.get() == 0:
                raise ValueError
            ...
            messagebox.showerror(title=None, message='Please select category and invalid ticket number')
